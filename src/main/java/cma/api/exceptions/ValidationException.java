...
public class ValidationException extends RuntimeException {
    ...
    private static String getValidationMessage(ObjectError error) {
        if (error instanceof FieldError) {
            ...
            return String.format("Validation error for field: %s.%s. The %s, but it is %s. Please insert a valid value in order for the data to be processed.", className, property, message, invalidValue);
        }
